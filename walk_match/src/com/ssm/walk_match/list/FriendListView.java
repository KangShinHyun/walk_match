...
import com.ssm.walk_match.main.FriendInfoActivity;
...
public class FriendListView extends ListView  {
	...
	class FriendListViewAdapter extends ArrayAdapter<FriendObject> {
		...
		private ImageView mChat1;
		private ImageView mChat2;
		private ImageView mChat3;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				...
				mChat1 = (ImageView) convertView.findViewById(R.id.friend_first_chat);
				mChat2 = (ImageView) convertView.findViewById(R.id.friend_two_chat);
				mChat3 = (ImageView) convertView.findViewById(R.id.friend_three_chat);
			...
			holder.chat1.setTag(R.id.imageId, position*3);
			holder.chat2.setTag(R.id.imageId, position*3+1);
			holder.chat3.setTag(R.id.imageId, position*3+2);
			holder.chat1.setVisibility(View.GONE);
			holder.chat2.setVisibility(View.GONE);
			holder.chat3.setVisibility(View.GONE);
			holder.chat1.setOnClickListener(new OnClickListener() {
			...
			holder.chat2.setOnClickListener(new OnClickListener() {
			...
			holder.chat3.setOnClickListener(new OnClickListener() {
			...
			holder.layout1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
						...
						((Activity)mContext).overridePendingTransition(0,0);
						((Activity)mContext).finish();
						BaseActivity.activity_num = BaseActivity.FRIEND_INFO_ACTIVITY;
				}
			});
			...
			if(position == friendList.size()/3)
			{
				if(friendList.size()%3 == 1)
				{
					...
					m_oAsyncImageLoader.setImageDrawableAsync(holder.img1, friendList.get(position*3).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
				...
				else if(friendList.size()%3 == 2)
				{
					...
					m_oAsyncImageLoader.setImageDrawableAsync(holder.img1, friendList.get(position*3).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
					holder.txt1.setText(friendList.get(position*3).getName());
					m_oAsyncImageLoader.setImageDrawableAsync(holder.img2, friendList.get(position*3+1).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
			...
			m_oAsyncImageLoader.setImageDrawableAsync(holder.img1, friendList.get(position*3).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
			m_oAsyncImageLoader.setImageDrawableAsync(holder.img2, friendList.get(position*3+1).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
			m_oAsyncImageLoader.setImageDrawableAsync(holder.img3, friendList.get(position*3+2).getImg(),getResources().getDrawable(R.drawable.cp_picture), getResources().getDrawable(R.drawable.cp_picture), mContext);
			holder.txt1.setText(friendList.get(position*3).getName());
			holder.txt2.setText(friendList.get(position*3+1).getName());
