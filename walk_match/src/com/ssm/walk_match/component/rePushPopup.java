...
public class rePushPopup extends LinearLayout implements View.OnClickListener, HttpClientNet.OnResponseListener  {
	...
	public rePushPopup(Context context,String email) {
	...
	private void initView() {
		...
		v = inflater.inflate(R.layout.popup_push_re, null);
		this.addView(v);
		...
		if(GCMIntentService.checkStyleTesase == 1)
		{
			img_change.setBackgroundResource(R.drawable.tease_imt_1);
			num = 1;
		}
		else if(GCMIntentService.checkStyleTesase == 2)
		{
			img_change.setBackgroundResource(R.drawable.tease_imt_2);
			num = 2;
		}
		else if(GCMIntentService.checkStyleTesase == 3)
		{
